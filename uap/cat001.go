...
// Cat001TrackV12 User Application Profile
// version 1.2
var Cat001TrackV12 = StandardUAP{
	Category: 1,
	Version:  1.2,
	Items: []DataField{
		{
		...
		{
			FRN: 2, DataItem: "I001/020", Type: TypeField{Name: "Extended", Size: 1},
		},
		{
...
var Cat001PlotV12 = StandardUAP{
	...
	Items: []DataField{
		...
		{
			FRN: 16, DataItem: "NA", Type: TypeField{Name: "NA"},
		},
		{
			FRN: 16, DataItem: "NA", Type: TypeField{Name: "NA"},
		},
		{
			FRN: 17, DataItem: "NA", Type: TypeField{Name: "NA"},
		},
		{
			FRN: 18, DataItem: "NA", Type: TypeField{Name: "NA"},
		},
		{
			FRN: 19, DataItem: "NA", Type: TypeField{Name: "NA"},
		},
		{
			FRN: 20, DataItem: "SP-Data Item", Type: TypeField{Name: "SP"},
		},
